...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <nav class="flex text-sm text-slate-500 mb-2">
            ...
            <span class="text-slate-800 font-medium">New Project</span>
        </nav>
        <h2 class="text-2xl font-bold text-slate-800">Create New Project</h2>
    </div>

    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <form action="<?= base_url('projects'); ?>" method="POST" class="p-8 space-y-6">
            <?= csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?= old('name'); ?>" required
                        ...
                        placeholder="e.g. Kabupaten Information System">
                </div>
            ...
            <div class="pt-6 border-t border-slate-100 flex items-center justify-end space-x-3">
                <a href="<?= base_url('projects'); ?>" class="px-6 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-100 rounded-xl transition-all">Cancel</a>
